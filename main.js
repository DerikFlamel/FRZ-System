    (() => {
      const GETFORM_ENDPOINT = 'https://getform.io/f/brogxoja'; // <-- TROQUE por sua URL do Getform
      ...
      // ------- Estado (localStorage para textos) -------
